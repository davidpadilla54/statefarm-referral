export const t = {
  en: {
    ...
    quotesToNext: (n, tierName) => `${n} more quote${n !== 1 ? 's' : ''} to reach`,
  ...
  es: {
    ...
    quotesToNext: (n, tierName) => `${n} cotización${n !== 1 ? 'es' : ''} más para llegar a`,
    platinumMsg: '¡Alcanzaste el nivel Platino — el más alto! Ganas $30 por cada referido para siempre.',
    submitted: 'enviados',
    quoted: 'cotizados',
